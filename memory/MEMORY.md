...
- [Music Generation (RunComfy)](music_generation.md) — skill `elevenlabs-music-generation` instalada Set/2026 pra trilha por contexto (ato/loja/descanso/boss). **NÃO usa a chave dos SFX** — é RunComfy CLI, outra conta; falta instalar o CLI e obter token. Custo ~US$0,0083/segundo. Plano de faixas + o que falta no AudioManager (crossfade).
