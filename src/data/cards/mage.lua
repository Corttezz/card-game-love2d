...
return {
    ...
    mage_zap = {
        ...
        description = "7 de dano. Canaliza 1 Raio (valor 3).",
    ...
    mage_dualcast = {
        ...
        description = "Evoca o orbe mais antigo e canaliza 1 Raio (valor 3).",
        image = "assets/cards/attack/theRock.png",
        rarity = "common", class = "mage",
    ...
    mage_ball_lightning = {
        ...
        description = "Causa 8 de dano. Canaliza 1 Raio (valor 5).",
        image = "assets/cards/attack/theRock.png",
    ...
    mage_lightning = {
        ...
        type = "attack", subtype = "common",
        cost = 1, attack = 8, defense = 0,
        description = "8 de dano. Canaliza Raio (valor 2).",
        image = "assets/cards/attack/theRock.png",
        rarity = "common", class = "mage",
        tags = { "strike", "channel", "lightning" },
        effects = {
    ...
    mage_fireball = {
        ...
        description = "Causa 11 de dano. Canaliza 1 Fogo (valor 3).",
        image = "assets/cards/attack/theRock.png",
        rarity = "common", class = "mage",
    ...
    mage_arcane_orb = {
        ...
        cost = 1, attack = 0, defense = 0,
        description = "Canaliza 1 orb escuro (valor 3).",
    ...
    mage_healing_drop = {
        ...
        cost = 1, attack = 0, defense = 0,
        description = "Cura 6 de HP. Canaliza 1 orbe Sagrado (valor 3).",
    ...
    mage_aggregate = {
        ...
        type = "effect", subtype = "skill",
        cost = 1, attack = 0, defense = 0,
        description = "Compra 2 cartas. Canaliza 1 orbe arcano (valor 2).",
        image = "assets/cards/attack/theRock.png",
        rarity = "uncommon", class = "mage",
    ...
    mage_blizzard = {
        ...
        description = "Causa 14 de dano magico (fixo). Canaliza 1 Gelo (valor 4).",
        image = "assets/cards/attack/theRock.png",
        rarity = "uncommon", class = "mage",
    ...
    mage_overcharge = {
        ...
        description = "9 de dano. Canaliza 1 Raio (valor 6).",
        image = "assets/cards/attack/theRock.png",
        rarity = "uncommon", class = "mage",
    ...
    mage_twin_bolts = {
        ...
        type = "attack", subtype = "skill",
        cost = 2, attack = 9, defense = 0,
        description = "Causa 18 de dano em 2 raios. Canaliza 1 Raio (valor 3).",
        image = "assets/cards/attack/theRock.png",
    ...
    mage_doom_and_gloom = {
        ...
        description = "Causa 10 de dano. Canaliza 1 Sombra (valor 5).",
        image = "assets/cards/attack/theRock.png",
        rarity = "uncommon", class = "mage",
    ...
    mage_frost_nova = {
        ...
        type = "attack", subtype = "skill",
        cost = 2, attack = 9, defense = 0,
        description = "9 de dano. Canaliza 1 Gelo (valor 4).",
        image = "assets/cards/attack/theRock.png",
        rarity = "uncommon", class = "mage",
    ...
    mage_radiant_prayer = {
        ...
        type = "effect", subtype = "skill",
        cost = 2, attack = 0, defense = 0,
        description = "Cura 5 de HP. Canaliza 1 orbe Sagrado (valor 5).",
        image = "assets/cards/effect/potionOfHealing.png",
        rarity = "uncommon", class = "mage",
        tags = { "heal", "channel", "holy", "magic" },
        effects = {
    ...
    mage_electrodynamics = {
        ...
        type = "joker", subtype = "power",
        cost = 2, attack = 0, defense = 0,
        description = "Canaliza 1 Raio (valor 2) no inicio de cada turno.",
        image = "assets/cards/defense/ironShield.png",
        rarity = "rare", class = "mage",
    ...
    mage_meteor_strike = {
        ...
        description = "18 de dano. Canaliza 3 orbes de Fogo (valor 4).",
        image = "assets/cards/attack/theRock.png",
        rarity = "rare", class = "mage",
    ...
    mage_primordial_storm = {
        ...
        type = "effect", subtype = "skill",
        cost = 3, attack = 0, defense = 0,
        description = "Canaliza Raio (valor 6), Gelo (valor 6) e Sombra (valor 4) e ganha +1 de Foco nesta batalha.",
        image = "assets/cards/effect/manaCrystal.png",
